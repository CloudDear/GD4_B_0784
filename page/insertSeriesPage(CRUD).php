...
solid #D40013; boxshadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);" >
    ...
    <hr>
    <form action="../process/insertSeriesProcess(CRUD).php" method="POST">
        <div class="mb-3">
            <label for="name" class="form-label">Nama Series</label>
        ...
        <div class="mb-3">
            <label for="realese" class="form-label">Episode</label>
